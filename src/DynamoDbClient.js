  ...
  function scan (params, { meta = false } = {}) {
    return new Promise((resolve, reject) =>
      documentClient.scan(params).promise()
        .then(data => resolve(meta ? data : data.Items))
    )
  }
  ...
  function get (params, { meta = false } = {}) {
    return new Promise((resolve, reject) =>
      documentClient.get(params).promise()
        .then(data => resolve(meta ? data : data.Item))
    )
  }
  ...
  function createItem (params, { meta = false } = {}) {
    return new Promise((resolve, reject) =>
      documentClient.put(params).promise()
        .then(() => resolve(meta ? params : params.Item))
    )
  }
  ...
  function updateItem (params, { meta = false } = {}) {
    return new Promise((resolve, reject) =>
      documentClient.update(params).promise()
        .then(data => resolve(meta ? data : data.Attributes))
      )
  }
